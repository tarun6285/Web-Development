...
@WebServlet(name = "NewBranch", urlPatterns = {"/NewBranch"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            out.println("<html>");
                ...
                out.println("<body>");
                out.println("<form action=\"NewBranch\" method =\"GET\">");
                String empName = request.getParameter("empName");
                out.println("<table width=\"60%\" align=\"center\" border=\"1\">");
                out.println("<tr align=\"center\"><td>");
                out.println(" Branch:   <input type=\"text\" name=\"empBranch\" /><br/><br/>");
                ...
                if (request.getParameter("sbtnNext") != null) {
                    if (!(branch.equals(""))) {
                        ...
                        session.setAttribute("empName",newName);
